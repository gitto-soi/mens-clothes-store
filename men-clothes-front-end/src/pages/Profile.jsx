      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-5 lg:gap-8">
          ...
          <aside className="w-full lg:w-72 flex-shrink-0">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden lg:sticky lg:top-24">
              ...
              <div className="p-4 sm:p-5 border-b border-gray-100 bg-gray-50/30">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-11 h-11 sm:w-12 sm:h-12 bg-gradient-to-r from-gray-700 to-gray-900 rounded-full flex items-center justify-center text-white font-bold text-base sm:text-lg flex-shrink-0">
            ...
            {/* Language selector */}
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 mt-5 p-4 sm:p-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  value={form.email}
                  disabled
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm sm:text-base text-gray-500 cursor-not-allowed"
                />
              </div>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto bg-gray-900 text-white font-medium py-2.5 px-8 rounded-xl hover:bg-gray-800 transition disabled:opacity-50 shadow-sm"
                >
